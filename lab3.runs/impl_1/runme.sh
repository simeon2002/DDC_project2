...
HD_PWD='/home/sims0702/DDC_project-main/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_pattern.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_pattern.tcl -notrace
