...
HD_PWD='/home/sims0702/DDC_project-main/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_pattern.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_pattern.tcl
