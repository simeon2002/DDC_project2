...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_counter__parameterized0\ is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_rFSM_current[4]_i_1__0\ : label is "soft_lutpair5";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FSM_resize_shape is
  ...
  signal \r_iShape_sizeX_next_reg[9]_i_7_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \r_iShape_sizeX_next_reg[0]_i_1\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \r_iShape_sizeX_next_reg[9]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \r_iShape_sizeX_next_reg[9]_i_4\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \r_iShape_sizeX_next_reg[9]_i_7\ : label is "soft_lutpair18";
  attribute XILINX_LEGACY_PRIM of \r_iShape_sizeY_next_reg[0]\ : label is "LD";
  attribute SOFT_HLUTNM of \r_iShape_sizeY_next_reg[0]_i_1\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \r_iShape_sizeY_next_reg[9]_i_4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \r_oShapeX_current[9]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \r_oShapeY_current[6]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \r_oShapeY_current[7]_i_3\ : label is "soft_lutpair21";
...
\r_iShape_sizeX_next_reg[9]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
\r_iShape_sizeX_next_reg[9]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF8"
    )
        port map (
...
\r_iShape_sizeX_next_reg[9]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
\r_iShape_sizeX_next_reg[9]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FSM_VGA_all is
  signal FSM_color_change_n_4 : STD_LOGIC;
  ...
  signal \^q\ : STD_LOGIC_VECTOR ( 9 downto 0 );
  signal \^orst_timer\ : STD_LOGIC;
  signal r_iRst_reg_i_2_n_0 : STD_LOGIC;
  ...
  attribute OPT_MODIFIED of r_iRst_reg : label is "MLO";
  attribute XILINX_LEGACY_PRIM : string;
  attribute XILINX_LEGACY_PRIM of r_iRst_reg : label is "LDC";
begin
  Q(9 downto 0) <= \^q\(9 downto 0);
...
r_iRst_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0',
      IS_G_INVERTED => '1'
    )
...
r_iRst_reg_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
oEn_jump_game_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
